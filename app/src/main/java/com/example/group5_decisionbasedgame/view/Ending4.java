...
public class Ending4 extends AppCompatActivity implements View.OnClickListener{
    TextView txtending;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enableFullscreen();
        setContentView(R.layout.activity_4thending);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnagain:
                AlertDialog.Builder builder = new AlertDialog.Builder(Ending4.this);
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(Ending4.this, LoadingScreen.class));
            ...
            case R.id.btnmainmenu:
                builder = new AlertDialog.Builder(Ending4.this);
                builder.setCancelable(true);
                builder.setTitle("Attention!");
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(Ending4.this, Main_Menu.class));
                        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                        bgmwin.stop();
                    }
                });
                ...
                break;
            case R.id.btnload:
                startActivity(new Intent(Ending4.this, LoadingScreen.class));//not finished
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                bgmwin.stop();
                break;
        }
