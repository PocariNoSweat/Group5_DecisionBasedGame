...
import com.example.group5_decisionbasedgame.controller.Scene3AvoidQuesDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene3AvoidQues extends AppCompatActivity implements View.OnClickListener{
    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene3AvoidQuesDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene3AvoidQuesDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene3AvoidQuesDlgFlow.firstscene(txtdlg, txtname, next, kenjigwapo, imgToni);
    }
        ...
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==6) {
                    startActivity(new Intent(Scene3AvoidQues.this, Ending3.class));//todo change class
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene3AvoidQues.this);
