...
import com.example.group5_decisionbasedgame.controller.Scene3ContinueHelpDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene3ContinueHelp extends AppCompatActivity implements View.OnClickListener {

    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene3ContinueHelpDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene3ContinueHelpDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene3ContinueHelpDlgFlow.secondscene(txtdlg, txtname, next, kenjigwapo);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==7) {
                    startActivity(new Intent(Scene3ContinueHelp.this, Scene3ContinueHelpScenario.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene3ContinueHelp.this);
