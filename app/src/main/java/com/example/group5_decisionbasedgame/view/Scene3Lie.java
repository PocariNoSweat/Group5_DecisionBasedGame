...
import com.example.group5_decisionbasedgame.controller.Scene3LieDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene3Lie extends AppCompatActivity implements View.OnClickListener{

    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene3LieDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene3LieDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene3LieDlgFlow.firstscene(txtdlg, txtname, next, kenjigwapo, imgToni);
    }
        ...
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==6) {
                    startActivity(new Intent(Scene3Lie.this, Scene3ContinueHelp.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene3Lie.this);
