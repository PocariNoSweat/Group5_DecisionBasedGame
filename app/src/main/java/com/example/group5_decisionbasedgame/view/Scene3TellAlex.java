...
public class Scene3TellAlex extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtdlg.setText("Alex declined to hear your story.");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnnextdlg:
                startActivity(new Intent(Scene3TellAlex.this, Scene2BlameOldManScenario.class));
