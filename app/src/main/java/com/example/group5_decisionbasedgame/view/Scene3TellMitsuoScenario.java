...
public class Scene3TellMitsuoScenario extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enableFullscreen();
        setContentView(R.layout.activity_scene3tellmitsuoscenario);
        ...
        ss.setSpan(fcsWhite, 0, 33, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ss.setSpan(fcsRed, 34, 48, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txtdecision4:
                startActivity(new Intent(Scene3TellMitsuoScenario.this, Scene4TMyes.class));
