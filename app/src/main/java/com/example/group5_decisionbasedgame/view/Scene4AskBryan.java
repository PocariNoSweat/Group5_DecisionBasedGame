...
import com.example.group5_decisionbasedgame.controller.Scene4AskBryanDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene4AskBryan extends AppCompatActivity implements View.OnClickListener {
    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene4AskBryanDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene4AskBryanDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene4AskBryanDlgFlow.thirdscene(txtdlg, txtname, next, kenjigwapo);
    }
        ...
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==25) {
                    startActivity(new Intent(Scene4AskBryan.this, Ending1.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene4AskBryan.this);
