...
import com.example.group5_decisionbasedgame.controller.Scene4IgnoreScratchDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene4IgnoreScratch extends AppCompatActivity implements View.OnClickListener{

    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene4IgnoreScratchDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene4IgnoreScratchDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene4IgnoreScratchDlgFlow.thirdscene(txtdlg, txtname, next, kenjigwapo);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==20) {
                    startActivity(new Intent(Scene4IgnoreScratch.this, Ending1.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene4IgnoreScratch.this);
