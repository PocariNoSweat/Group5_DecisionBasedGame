...
import com.example.group5_decisionbasedgame.controller.Scene4TellEveryoneDlgFlow;
import com.example.group5_decisionbasedgame.model.ScenarioDialogues;

public class Scene4TellEveryone extends AppCompatActivity implements View.OnClickListener {
    Button btnnextdlg, btnsavegame, btnskipdlg, btnpause;
    TextView txtdlg, txtname;
    Scene4TellEveryoneDlgFlow kenjigwapo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kenjigwapo = new Scene4TellEveryoneDlgFlow();
        next = new ScenarioDialogues();
        dlgscene = findViewById(R.id.dlgscene);

        Scene4TellEveryoneDlgFlow.thirdscene(txtdlg, txtname, next, kenjigwapo, imgMitsuo);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnnextdlg:
                ...
                if (next.getnextdlg()==23) {
                    startActivity(new Intent(Scene4TellEveryone.this, Ending1.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    bgm.stop();
                }
                break;
            case R.id.btnskipdlg:
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene4TellEveryone.this);
