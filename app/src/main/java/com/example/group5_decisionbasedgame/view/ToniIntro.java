...
import com.example.group5_decisionbasedgame.R;
    ...
    public class ToniIntro extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            enableFullscreen();
            setContentView(R.layout.activity_toniintro);
            ...
            toniid.setOnClickListener(v -> {
                touchCount[0] = touchCount[0] + 1;
                if (touchCount[0] == 3) {
                    startActivity(new Intent(ToniIntro.this, BryanIntro.class));//When button is touched, it will take you to the next character
